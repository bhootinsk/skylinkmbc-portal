    ...
    <div class="max-w-md mx-auto px-4 py-12">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
            ...
            <p class="text-sm text-slate-600 mb-6">
                Sign in to access your secure file portal.
            </p>
            ...
            <div class="mt-6 pt-6 border-t border-slate-200 text-sm text-slate-600">
                <p class="font-medium text-slate-700 mb-1">Need an account?</p>
                <p>Contact <a href="mailto:admin@skylinkmbc.biz" class="text-skylink-700 hover:underline">admin@skylinkmbc.biz</a> to request access.</p>
            </div>
        </div>
    </div>
</x-portal-layout>
